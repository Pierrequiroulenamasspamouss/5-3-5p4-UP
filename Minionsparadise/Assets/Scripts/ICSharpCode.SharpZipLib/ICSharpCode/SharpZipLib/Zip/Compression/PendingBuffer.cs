namespace ICSharpCode.SharpZipLib.Zip.Compression
{
	public class PendingBuffer
	{
		...
		{
			global::System.Array.Copy(block, offset, buffer_, end, length);
			end += length;
		}
		...
		public int Flush(byte[] output, int offset, int length)
		{
			...
			{
				length = end - start;
				global::System.Array.Copy(buffer_, start, output, offset, length);
				start = 0;
				end = 0;
			}
			else
		...
		public byte[] ToByteArray()
		{
			...
			global::System.Array.Copy(buffer_, start, array, 0, array.Length);
			start = 0;
			end = 0;
			return array;
		}
