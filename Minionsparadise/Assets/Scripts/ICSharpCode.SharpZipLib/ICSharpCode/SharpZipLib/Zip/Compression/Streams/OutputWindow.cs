namespace ICSharpCode.SharpZipLib.Zip.Compression.Streams
{
	public class OutputWindow
	{
		...
		public void Write(int value)
		{
			...
			{
				throw new global::System.InvalidOperationException("Window full");
			}
		...
		public void Repeat(int length, int distance)
		{
			...
			if (num <= num2 && windowEnd < num2)
			{
				if (length <= distance)
				{
					global::System.Array.Copy(window, num, window, windowEnd, length);
					windowEnd += length;
				}
				else
				{
		...
		public int CopyStored(global::ICSharpCode.SharpZipLib.Zip.Compression.Streams.StreamManipulator input, int length)
		{
			length = global::System.Math.Min(global::System.Math.Min(length, 32768 - windowFilled), input.AvailableBytes);
		...
		public void CopyDict(byte[] dictionary, int offset, int length)
		{
			...
			global::System.Array.Copy(dictionary, offset, window, 0, length);
		...
		public int CopyOutput(byte[] output, int offset, int len)
		{
			...
			if (num3 > 0)
			{
				global::System.Array.Copy(window, 32768 - num3, output, offset, num3);
				offset += num3;
				len = num;
			}
			global::System.Array.Copy(window, num - len, output, offset, len);
			windowFilled -= num2;
			if (windowFilled < 0)
			{
				throw new global::System.InvalidOperationException();
