...
{
	internal class ZipAESStream : global::System.Security.Cryptography.CryptoStream
	{
		...
		private global::ICSharpCode.SharpZipLib.Encryption.ZipAESTransform _transform;
		...
		public ZipAESStream(global::System.IO.Stream stream, global::ICSharpCode.SharpZipLib.Encryption.ZipAESTransform transform, global::System.Security.Cryptography.CryptoStreamMode mode)
			: base(stream, transform, mode)
		{
			...
			_blockAndAuth = 26;
			if (mode != global::System.Security.Cryptography.CryptoStreamMode.Read)
			{
				throw new global::System.Exception("ZipAESStream only for read");
			}
		}
		...
		public override int Read(byte[] outBuffer, int offset, int count)
		{
			...
			while (num < count)
			{
				...
				{
					throw new global::System.Exception("Internal error missed auth code");
				}
				...
				for (int i = 0; i < 10; i++)
				{
					...
					{
						throw new global::System.Exception("AES Authentication Code does not match. This is a super-CRC check on the data in the file after compression and encryption. \r\nThe file may be damaged.");
					}
				}
				break;
			}
