        ...
        public static void Migrate()
        {
            ...
            foreach (string scene in scenes)
            {
                ...
                foreach (var emitter in emitters)
                {
                    ...
                    newEmitter.StopEvent = EmitterGameEvent.ObjectDestroy;
                }
                ...
                foreach (var listener in listeners)
                {
                    ...
                    {
                        var pluginsField = typeof(FMODUnity.Settings).GetField("Plugins", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Public);
                        if (pluginsField != null)
                        {
                            List<string> pluginsList = pluginsField.GetValue(settings) as List<string>;
                            if (pluginsList != null && !pluginsList.Contains(plugin))
                            {
