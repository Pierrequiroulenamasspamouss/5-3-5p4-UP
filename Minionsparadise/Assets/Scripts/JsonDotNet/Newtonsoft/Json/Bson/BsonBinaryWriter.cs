...
namespace Newtonsoft.Json.Bson
{
    ...
    {
        private static readonly Encoding Encoding = global::System.Text.Encoding.UTF8;
                ...
                case BsonType.Object:
                    {
                        ...
                        foreach (BsonProperty item in bsonObject)
                        {
                            ...
                            // Modified: Use -1 instead of null
                            WriteString((string)item.Name.Value, item.Name.ByteCount, -1);
                ...
                case BsonType.Array:
                    {
                        ...
                        foreach (BsonToken item2 in bsonArray)
                        {
                            ...
                            // Modified: Use -1 instead of null
                            WriteString(num2.ToString(CultureInfo.InvariantCulture), MathUtils.IntLength(num2), -1);
                ...
                case BsonType.String:
                    {
                        ...
                        // Modified: calculatedlengthPrefix is passed as a standard int
                ...
                case BsonType.Regex:
                    {
                        ...
                        // Modified: Use -1 instead of null
                        WriteString((string)bsonRegex.Pattern.Value, bsonRegex.Pattern.ByteCount, -1);
                        WriteString((string)bsonRegex.Options.Value, bsonRegex.Options.ByteCount, -1);
                        break;
                    }
                default:
        ...
        // Modified: changed int? to int
        private void WriteString(string s, int byteCount, int calculatedlengthPrefix)
        {
            // Modified: Check for -1 instead of .HasValue
            if (calculatedlengthPrefix != -1)
            {
                _writer.Write(calculatedlengthPrefix);
            }
            if (s != null)
            {
