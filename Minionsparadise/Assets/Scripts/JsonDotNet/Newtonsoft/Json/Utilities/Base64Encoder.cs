namespace Newtonsoft.Json.Utilities
{
	internal class Base64Encoder
	{
		...
		public Base64Encoder(global::System.IO.TextWriter writer)
		{
		...
		public void Encode(byte[] buffer, int index, int count)
		{
			...
			if (_leftOverBytesCount > 0)
			{
				...
				int count2 = global::System.Convert.ToBase64CharArray(_leftOverBytes, 0, 3, _charsLine, 0);
			...
			while (index < num)
			{
				...
				int count3 = global::System.Convert.ToBase64CharArray(buffer, index, num2, _charsLine, 0);
		...
		public void Flush()
		{
			if (_leftOverBytesCount > 0)
			{
				int count = global::System.Convert.ToBase64CharArray(_leftOverBytes, 0, _leftOverBytesCount, _charsLine, 0);
