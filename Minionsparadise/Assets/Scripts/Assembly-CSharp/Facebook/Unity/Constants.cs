namespace Discord.Unity
{
    internal static class Constants
    {
        ...
        public static global::System.Uri GraphUrl
        {
            get
            {
                string uriString = string.Format(
                    ...
                    "https://graph.{0}/{1}/",
                    global::Discord.Unity.FB.FacebookDomain,
                    global::Discord.Unity.FB.GraphApiVersion
                );
        ...
        public static string GraphApiUserAgent
        {
            get
            {
                return string.Format(
                    global::System.Globalization.CultureInfo.InvariantCulture,
                    "{0} {1}",
                    global::Discord.Unity.FB.FacebookImpl.SDKUserAgent,
                    UnitySDKUserAgent
                );
            }
        }
        ...
        public static bool IsMobile
        {
            get
            {
                return CurrentPlatform == global::Discord.Unity.FacebookUnityPlatform.Android
                    || CurrentPlatform == global::Discord.Unity.FacebookUnityPlatform.IOS;
            }
        }
        ...
        public static string UnitySDKUserAgentSuffixLegacy
        {
            get
            {
                return string.Format(
                    global::System.Globalization.CultureInfo.InvariantCulture,
                    "Unity.{0}",
                    global::Discord.Unity.FacebookSdkVersion.Build
                );
            }
        }
        ...
        public static string UnitySDKUserAgent
        {
            get
            {
                return global::Discord.Unity.Utilities.GetUserAgent(
                    "FBUnitySDK",
                    global::Discord.Unity.FacebookSdkVersion.Build
                );
            }
