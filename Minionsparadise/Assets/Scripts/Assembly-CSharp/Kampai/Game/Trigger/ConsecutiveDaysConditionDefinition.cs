...
{
	public class ConsecutiveDaysConditionDefinition : global::Kampai.Game.Trigger.TriggerConditionDefinition
	{
		...
		public override global::Kampai.Game.Trigger.TriggerConditionType.Identifier type
		{
			get
			{
				return global::Kampai.Game.Trigger.TriggerConditionType.Identifier.ConsecutiveDays;
			}
		}
		...
		public override bool IsTriggered(global::strange.extensions.context.api.ICrossContextCapable gameContext)
		{
			...
			return TestOperator(Days, (int)instance.GetQuantity(global::Kampai.Game.StaticItem.CONSECUTIVE_DAYS_COUNT));
		}
	}
}
