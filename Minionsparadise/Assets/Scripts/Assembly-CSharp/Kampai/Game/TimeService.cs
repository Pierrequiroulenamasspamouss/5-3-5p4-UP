namespace Kampai.Game
{
	public class TimeService : global::Kampai.Game.ITimeService
	{
        ...
        public TimeService()
        {
            // Use DateTime.UtcNow for a consistent start point across all platforms
            startTime = global::System.DateTime.UtcNow;

            // Alternatively, if you need to know how long the app has been running:
            // float uptime = UnityEngine.Time.realtimeSinceStartup;
