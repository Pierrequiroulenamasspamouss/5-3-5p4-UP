...
{
	public class EnvironmentResourceDefinition : global::Kampai.Util.IFastJSONDeserializable
	{
		public global::System.Collections.Generic.IList<string> environmentResources { get; set; }
		...
		protected virtual bool DeserializeProperty(string propertyName, global::Newtonsoft.Json.JsonReader reader, JsonConverters converters)
		{
			...
			case "ENVIRONMENTRESOURCES":
				reader.Read();
				environmentResources = global::Kampai.Util.ReaderUtil.PopulateList(reader, converters, global::Kampai.Util.ReaderUtil.ReadString, environmentResources);
				return true;
			default:
				return false;
			}
