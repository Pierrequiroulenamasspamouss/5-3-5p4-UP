...
{
	public class AssetsPreloadList : global::Kampai.Util.IFastJSONDeserializable
	{
		public global::System.Collections.Generic.List<global::Kampai.Main.PreloadableAsset> AssetsList { get; set; }
		...
		protected virtual bool DeserializeProperty(string propertyName, global::Newtonsoft.Json.JsonReader reader, JsonConverters converters)
		{
			...
			case "ASSETSLIST":
				reader.Read();
				AssetsList = global::Kampai.Util.ReaderUtil.PopulateList<global::Kampai.Main.PreloadableAsset>(reader, converters, global::Kampai.Util.ReaderUtil.ReadPreloadableAsset, AssetsList);
				return true;
			default:
				return false;
			}
