...
{
	public class PlayerStatsObject : global::Google.Developers.JavaObjWrapper, global::Com.Google.Android.Gms.Games.Stats.PlayerStats
	{
		...
		public static float UNSET_VALUE
		{
			get
			{
				return global::Google.Developers.JavaObjWrapper.GetStaticFloatField("com/google/android/gms/games/stats/PlayerStats", "UNSET_VALUE");
			}
		}
		...
		public static int CONTENTS_FILE_DESCRIPTOR
		{
			get
			{
				return global::Google.Developers.JavaObjWrapper.GetStaticIntField("com/google/android/gms/games/stats/PlayerStats", "CONTENTS_FILE_DESCRIPTOR");
			}
		}
		...
		public static int PARCELABLE_WRITE_RETURN_VALUE
		{
			get
			{
				return global::Google.Developers.JavaObjWrapper.GetStaticIntField("com/google/android/gms/games/stats/PlayerStats", "PARCELABLE_WRITE_RETURN_VALUE");
			}
		}

		public PlayerStatsObject(global::System.IntPtr ptr)
			: base(ptr)
		{
		}
