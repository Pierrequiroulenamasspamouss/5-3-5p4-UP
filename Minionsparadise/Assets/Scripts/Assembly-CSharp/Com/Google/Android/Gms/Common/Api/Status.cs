...
{
	public class Status : global::Google.Developers.JavaObjWrapper, global::Com.Google.Android.Gms.Common.Api.Result
	{
		...
		public static object CREATOR
		{
			get
			{
				return global::Google.Developers.JavaObjWrapper.GetStaticObjectField<object>("com/google/android/gms/common/api/Status", "CREATOR", "Landroid/os/Parcelable$Creator;");
			}
		}
		...
		public static string NULL
		{
			get
			{
				return global::Google.Developers.JavaObjWrapper.GetStaticStringField("com/google/android/gms/common/api/Status", "NULL");
			}
		}
		...
		public static int CONTENTS_FILE_DESCRIPTOR
		{
			get
			{
				return global::Google.Developers.JavaObjWrapper.GetStaticIntField("com/google/android/gms/common/api/Status", "CONTENTS_FILE_DESCRIPTOR");
			}
		}
		...
		public static int PARCELABLE_WRITE_RETURN_VALUE
		{
			get
			{
				return global::Google.Developers.JavaObjWrapper.GetStaticIntField("com/google/android/gms/common/api/Status", "PARCELABLE_WRITE_RETURN_VALUE");
			}
		}

		public Status(global::System.IntPtr ptr)
			: base(ptr)
		{
		}
		...
		{
			return InvokeCall<global::Com.Google.Android.Gms.Common.Api.Status>("getStatus", "()Lcom/google/android/gms/common/api/Status;", new object[0]);
		}
