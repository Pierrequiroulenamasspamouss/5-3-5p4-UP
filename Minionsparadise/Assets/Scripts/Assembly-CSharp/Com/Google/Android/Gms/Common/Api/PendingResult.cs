...
{
	public class PendingResult<R> : global::Google.Developers.JavaObjWrapper where R : global::Com.Google.Android.Gms.Common.Api.Result
	{
		private const string CLASS_NAME = "com/google/android/gms/common/api/PendingResult";

		public PendingResult(global::System.IntPtr ptr)
			: base(ptr)
		{
		}
		...
		public void setResultCallback(global::Com.Google.Android.Gms.Common.Api.ResultCallback<R> arg_ResultCallback_1)
		{
			InvokeCallVoid("setResultCallback", "(Lcom/google/android/gms/common/api/ResultCallback;)V", arg_ResultCallback_1);
		}

		public void setResultCallback(global::Com.Google.Android.Gms.Common.Api.ResultCallback<R> arg_ResultCallback_1, long arg_long_2, object arg_object_3)
		{
